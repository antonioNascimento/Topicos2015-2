...
/**
 * Created by Antonio on 21/09/2015.
 */
public class TelaMenu extends TelaBase {
    ...
    public TelaMenu(MainGame mainGame) {
        super(mainGame);
    }
    ...
    private void initBotoes() {
        ...
        btnIniciar.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                mainGame.setScreen(new TelaGame(mainGame));
            }
        });
    }
    ...
    private void atualizarLabels() {
        ...
        x = camera.viewportWidth / 2 - lbTitulo.getPrefWidth() / 2;
        y = 100;
